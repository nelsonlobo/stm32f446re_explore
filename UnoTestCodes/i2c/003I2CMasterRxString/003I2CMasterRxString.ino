...
void loop() {
  ...
  Wire.requestFrom(STM32_SLAVE_ADDR,1); // Request the transmitted two bytes from the two registers
  ...
  Wire.requestFrom(STM32_SLAVE_ADDR,data_len);
