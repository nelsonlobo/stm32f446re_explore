...
void setup() 
{
  ...
  pinMode(GPIO_INTR_DRV_PIN, INPUT_PULLUP);
  //digitalWrite(8,LOW);
...
{
  pinMode(GPIO_INTR_DRV_PIN,OUTPUT);
  digitalWrite(GPIO_INTR_DRV_PIN,HIGH);
  delayMicroseconds(50);
  digitalWrite(GPIO_INTR_DRV_PIN,LOW);
}
