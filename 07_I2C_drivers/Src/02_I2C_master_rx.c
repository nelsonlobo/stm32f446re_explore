...
//		printf("Sent I2C data \n");
		...
		cmd_code = 0x51;
		I2C_MasterSendData(&I2C1handle, &cmd_code, 1,ARDUINO_SLAVE_ADDR);
		I2C_MasterReceiveData(&I2C1handle, &len, 1,ARDUINO_SLAVE_ADDR);

		cmd_code = 0x52;
		I2C_MasterSendData(&I2C1handle, &cmd_code, 1,ARDUINO_SLAVE_ADDR);
		I2C_MasterReceiveData(&I2C1handle,rx_buff, len,ARDUINO_SLAVE_ADDR);
...
void I2C1_Inits(void)
{
	...
	I2C1handle.I2C_Config.I2C_RepeatedStart = ENABLE;
